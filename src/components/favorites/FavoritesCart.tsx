                ...
                <div className=" w-full">
                    ...
                    <div className=" py-4 flex items-center gap-2">
                        <div className="text-white min-w-[120px] w-full bg-[#333333] px-3 text-center rounded-[40px] py-3">
                            <button className="text-[14px] font-normal">Select options</button>
                        </div>
                        <div>
                            <div className=" w-[45px] h-[45px] cursor-pointer flex items-center justify-center gap-2 bg-[#eaeaea] rounded-full">
