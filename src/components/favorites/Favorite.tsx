        ...
        <div
            ...
            <div className=" md:py-6 overflow-hidden">
                <div className=" flex justify-between items-center gap-2">
                    <div onClick={() => { dispatch(accountToggle()), dispatch(FavoriteToggle()) }} className=" flex  cursor-pointer items-center gap-2" >
                        <div>
                ...
                <div className=" pt-6  max-h-[90vh] overflow-y-auto cartScroolbar">
                    ...
                    <div>
                        ...
                        {
                            !favorite && <div className="  h-full flex justify-center items-center flex-col min-h-[70vh]">
                                <h1 className=" text-[18px] md:text-[28px]  text-center font-semibold py-2">{"You don's have any favorites yet"} </h1>
                                <p className="text-[14px]  md:text-[18px]  text-center text-gray-800"> Top the heart on any product to save it to your favorites</p>
